...
namespace my_books
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Uygulama içerisinde bağımlılık olarak oluşturduğumuz ve
            //kullandığımız nesnenin her kullanım ve çağrıda tekrardan oluşturulmasını sağlar.
           ...
           services.AddTransient<BooksService>();
            ...
            services.AddApiVersioning(config =>
            {
                ...
                //config.ApiVersionReader = new HeaderApiVersionReader("custom-verion-header");
