...
namespace my_books_tests
{
    public class PublisherControllerTests
    {
        ...
        public void HTTPGET_GetAllPublishers_WithSortBySearchPageNr_ReturnOk_Test()
        {
            ...
            Assert.That(actionResultDataSecondPage.First().Name, Is.EqualTo("Publisher 4"));
            Assert.That(actionResultDataSecondPage.First().Id, Is.EqualTo(4));
            Assert.That(actionResultDataSecondPage.Count, Is.EqualTo(4));
        }
